(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', 'camelcase'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('camelcase'));
  } else {
    var mod = {
      exports: {}
    };
  ...
  var _camelCase = _interopRequireDefault(_camelcase);
  ...
  module.exports = function (CustomElement) {
    ...
    ReactClass.displayName = (0, _camelCase['default'])(CustomElement.id);
